...
public class BookService {
    ...
    public Page<Book> getForAllFavoriteBooks(int pageNumber, int pageSize, String sortField, String name, String author, String country, Genre genre, User user) {
        name = "%" + name + "%";
        author = "%" + author + "%";
        country = "%" + country + "%";
        ...
        if(genre == null)
            page = bookRepository.findAll(name, author, country, user, pageable);
        else
            page = bookRepository.findAll(name, author, country, genre, user, pageable);
    ...
    public void deleteFavoriteUserForBook(Integer bookId, Integer userId) {
        bookRepository.deleteFavoriteBookForUser(bookId, userId);
    }
    public void deleteAllFavoriteUserForBook(Integer bookId) {
        bookRepository.deleteAllFavoriteBookForUser(bookId);
    }
}
